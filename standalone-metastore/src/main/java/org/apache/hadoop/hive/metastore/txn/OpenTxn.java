...
public class OpenTxn {
  ...
  public static final String OPEN_TXNS_INFO_QUERY = "select txn_id, txn_state, txn_type, txn_user, txn_host, txn_started, txn_last_heartbeat "
      + "from TXNS where txn_id <= %s order by txn_id";
