            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.excludeTxnTypes = new ArrayList<TxnType>(_list1128.size);
                TxnType _elem1129;
                for (int _i1130 = 0; _i1130 < _list1128.size; ++_i1130)
                {
                  _elem1129 = org.apache.hadoop.hive.metastore.api.TxnType.findByValue(iprot.readI32());
                  struct.excludeTxnTypes.add(_elem1129);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, GetOpenTxnsRequest struct) throws org.apache.thrift.TException {
      ...
      if (struct.excludeTxnTypes != null) {
        oprot.writeFieldBegin(EXCLUDE_TXN_TYPES_FIELD_DESC);
        {
          ...
          for (TxnType _iter1131 : struct.excludeTxnTypes)
          {
            oprot.writeI32(_iter1131.getValue());
          }
          oprot.writeListEnd();
        }
        oprot.writeFieldEnd();
  ...
  private static class GetOpenTxnsRequestTupleScheme extends TupleScheme<GetOpenTxnsRequest> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, GetOpenTxnsRequest struct) throws org.apache.thrift.TException {
      TTupleProtocol oprot = (TTupleProtocol) prot;
      {
        ...
        for (TxnType _iter1132 : struct.excludeTxnTypes)
        {
          oprot.writeI32(_iter1132.getValue());
        }
      }
    }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, GetOpenTxnsRequest struct) throws org.apache.thrift.TException {
      ...
      {
        org.apache.thrift.protocol.TList _list1133 = new org.apache.thrift.protocol.TList(org.apache.thrift.protocol.TType.I32, iprot.readI32());
        struct.excludeTxnTypes = new ArrayList<TxnType>(_list1133.size);
        TxnType _elem1134;
        for (int _i1135 = 0; _i1135 < _list1133.size; ++_i1135)
        {
          _elem1134 = org.apache.hadoop.hive.metastore.api.TxnType.findByValue(iprot.readI32());
          struct.excludeTxnTypes.add(_elem1134);
        }
      }
      struct.setExcludeTxnTypesIsSet(true);
    }
